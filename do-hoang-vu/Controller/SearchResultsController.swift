...
class SearchResultsController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    override func viewDidLoad() {
     ...
     func registerNotification() {
        NotificationCenter.default.addObserver(self, selector: #selector(reloadData), name: .sendRequest, object: nil)
    }
    @objc func reloadData() {
         searchResults = DataService.shared.result
        ...
        let task = URLSession.shared.dataTask(with: url! as URL) { (data, response, error) -> Void in
            ...
            do {
                if data != nil{
                    ...
                    DataService.shared.lat = lat
                    DataService.shared.lon = lon
                    DataService.shared.title = self.searchResults[indexPath.row]
